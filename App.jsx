                    ...
                    return (
                      <div key={category} style={{
                        ...
                        <div style={{ height: '6px', backgroundColor: COLORS.border, borderRadius: '3px', overflow: 'hidden' }}>
                          <div style={{ height: '100%', width: `${warehousePercent}%`, backgroundColor: status.color, borderRadius: '3px' }}></div>
                        </div>
                      </div>
                    );
                  })}
...
function AdminPanel({ users, allowedUsers, onAddAllowedUser, onDeleteUser }) {
  ...
  return (
    <div>
      ...
      <div style={{ backgroundColor: '#0f1623', padding: '20px', borderRadius: '6px', border: `1px solid #1e2a3a`, marginBottom: '20px' }}>
        <h3 style={{ color: '#4fc3f7' }}>Допущені користувачи</h3>
      ...
      <div style={{ backgroundColor: '#0f1623', padding: '20px', borderRadius: '6px', border: `1px solid #1e2a3a`, marginBottom: '20px' }}>
        <h3 style={{ color: '#4fc3f7' }}>Активні користувачи</h3>
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '12px' }}>
          <thead>
            <tr style={{ backgroundColor: '#0a0f1a', borderBottom: `1px solid #1e2a3a` }}>
              <th style={{ padding: '8px', textAlign: 'left', color: '#4fc3f7' }}>Ім'я</th>
